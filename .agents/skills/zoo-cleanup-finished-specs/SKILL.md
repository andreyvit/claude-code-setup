...
- `## Pending suggestions` is empty

Do not archive draft specs, specs without subtasks, specs with open Pending suggestions, or ambiguous completion. Report candidates left active.
