---
name: zoo-researcher
description: Researches the codebase and distills findings into a Zoo research file. Use only as part of the Zoo workflow.
model: opus
---
...
Quote enough code that later steps do not need to reread most of the files involved. Quote snippets for all code references you put in. The output can and should be fairly long!
